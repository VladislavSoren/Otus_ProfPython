...
class RegisterForm(UserCreationForm):
    ...
    logo = forms.ImageField(widget=forms.FileInput(attrs={'class': 'form-control', 'style': 'width: 500px;'}),
...
class UserUpdateForm(forms.ModelForm):
    ...
    logo = forms.ImageField(
        widget=ModifiedClearableFileInput(attrs={'class': 'form-control', 'style': 'width: 500px;'}), required=False,
        label='Avatar')
